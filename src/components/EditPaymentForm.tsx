...
const EditPaymentForm: React.FC<EditPaymentFormProps> = ({ 
  ...
  const [formData, setFormData] = useState({
    ...
    type: payment.type,
    recurringDuration: payment.recurringDuration || '12',
    customEndDate: payment.customEndDate || '',
    note: payment.note,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (formData.type === 'recurring') {
      updates.recurringDuration = formData.recurringDuration;
      if (formData.recurringDuration === 'Custom' && formData.customEndDate) {
        updates.customEndDate = formData.customEndDate;
      } else {
        updates.customEndDate = undefined;
      }
    } else {
      updates.recurringDuration = undefined;
      updates.customEndDate = undefined;
    }

    // Update the payment - this will automatically close the modal via the parent component
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <label className="flex items-center cursor-pointer">
                ...
                <span style={{ color: theme.colors.text }}>Recurring</span>
              </label>
              ...
              <label className="flex items-center cursor-pointer">
                ...
                <span style={{ color: theme.colors.text }}>One-off</span>
              </label>
            </div>
          </div>
          ...
          <button
            type="submit"
            className="w-full py-3 px-4 rounded-lg font-medium flex items-center justify-center transition-all duration-200 hover:shadow-lg"
            style={{
